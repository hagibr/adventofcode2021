...
# Vamos montar o supermapa agora
# Quintuplicando as colunas de cada uma das linhas
data5 = []
for n0 in data:
    n1 = [(v%9+1) for v in n0]
    n2 = [(v%9+1) for v in n1]
    n3 = [(v%9+1) for v in n2]
    n4 = [(v%9+1) for v in n3]
    data5.append(n0+n1+n2+n3+n4)

# Quintuplicando as linhas. Deve ter jeito mais simples de fazer.
more1 = []
for r in data5:
    n = [(v%9+1) for v in r]
    more1.append(n)
...
# Trabalharemos com esse novo mapa extendido
data = data5
...
# Dá pra ver a lista completa agora. Mas deixa pra lá, ela demora mais para ser impressa do que para ser calculada.
